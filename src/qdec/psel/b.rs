...
pub type R = crate::R<BSpec>;
#[doc = "Register `B` writer"]
pub type W = crate::W<BSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<BSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<BSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<BSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for B signal\n\nYou can [`read`](crate::Reg::read) this register and get [`b::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`b::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BSpec;
impl crate::RegisterSpec for BSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`b::R`](R) reader structure"]
impl crate::Readable for BSpec {}
#[doc = "`write(|w| ..)` method takes [`b::W`](W) writer structure"]
impl crate::Writable for BSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets B to value 0xffff_ffff"]
impl crate::Resettable for BSpec {
