...
pub type R = crate::R<CsnSpec>;
#[doc = "Register `CSN` writer"]
pub type W = crate::W<CsnSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<CsnSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<CsnSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<CsnSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for CSN\n\nYou can [`read`](crate::Reg::read) this register and get [`csn::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`csn::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CsnSpec;
impl crate::RegisterSpec for CsnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csn::R`](R) reader structure"]
impl crate::Readable for CsnSpec {}
#[doc = "`write(|w| ..)` method takes [`csn::W`](W) writer structure"]
impl crate::Writable for CsnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CSN to value 0xffff_ffff"]
impl crate::Resettable for CsnSpec {
