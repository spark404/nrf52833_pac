...
pub type R = crate::R<PseldcxSpec>;
#[doc = "Register `PSELDCX` writer"]
pub type W = crate::W<PseldcxSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<PseldcxSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<PseldcxSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<PseldcxSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for DCX signal\n\nYou can [`read`](crate::Reg::read) this register and get [`pseldcx::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pseldcx::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PseldcxSpec;
impl crate::RegisterSpec for PseldcxSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pseldcx::R`](R) reader structure"]
impl crate::Readable for PseldcxSpec {}
#[doc = "`write(|w| ..)` method takes [`pseldcx::W`](W) writer structure"]
impl crate::Writable for PseldcxSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PSELDCX to value 0xffff_ffff"]
impl crate::Resettable for PseldcxSpec {
