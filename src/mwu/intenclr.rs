...
impl W {
    #[doc = "Bit 0 - Write '1' to disable interrupt for event REGION0WA"]
    #[inline(always)]
    pub fn region0wa(&mut self) -> Region0waW<IntenclrSpec> {
        Region0waW::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to disable interrupt for event REGION0RA"]
    #[inline(always)]
    pub fn region0ra(&mut self) -> Region0raW<IntenclrSpec> {
        Region0raW::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to disable interrupt for event REGION1WA"]
    #[inline(always)]
    pub fn region1wa(&mut self) -> Region1waW<IntenclrSpec> {
        Region1waW::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to disable interrupt for event REGION1RA"]
    #[inline(always)]
    pub fn region1ra(&mut self) -> Region1raW<IntenclrSpec> {
        Region1raW::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to disable interrupt for event REGION2WA"]
    #[inline(always)]
    pub fn region2wa(&mut self) -> Region2waW<IntenclrSpec> {
        Region2waW::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to disable interrupt for event REGION2RA"]
    #[inline(always)]
    pub fn region2ra(&mut self) -> Region2raW<IntenclrSpec> {
        Region2raW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to disable interrupt for event REGION3WA"]
    #[inline(always)]
    pub fn region3wa(&mut self) -> Region3waW<IntenclrSpec> {
        Region3waW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to disable interrupt for event REGION3RA"]
    #[inline(always)]
    pub fn region3ra(&mut self) -> Region3raW<IntenclrSpec> {
        Region3raW::new(self, 7)
    }
    #[doc = "Bit 24 - Write '1' to disable interrupt for event PREGION0WA"]
    #[inline(always)]
    pub fn pregion0wa(&mut self) -> Pregion0waW<IntenclrSpec> {
        Pregion0waW::new(self, 24)
    }
    #[doc = "Bit 25 - Write '1' to disable interrupt for event PREGION0RA"]
    #[inline(always)]
    pub fn pregion0ra(&mut self) -> Pregion0raW<IntenclrSpec> {
        Pregion0raW::new(self, 25)
    }
    #[doc = "Bit 26 - Write '1' to disable interrupt for event PREGION1WA"]
    #[inline(always)]
    pub fn pregion1wa(&mut self) -> Pregion1waW<IntenclrSpec> {
        Pregion1waW::new(self, 26)
    }
    #[doc = "Bit 27 - Write '1' to disable interrupt for event PREGION1RA"]
    #[inline(always)]
    pub fn pregion1ra(&mut self) -> Pregion1raW<IntenclrSpec> {
