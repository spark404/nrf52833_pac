...
impl W {
    #[doc = "Bit 0 - Enable write access watch in region\\[0\\]"]
    #[inline(always)]
    pub fn rgn0wa(&mut self) -> Rgn0waW<RegionensetSpec> {
        Rgn0waW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable read access watch in region\\[0\\]"]
    #[inline(always)]
    pub fn rgn0ra(&mut self) -> Rgn0raW<RegionensetSpec> {
        Rgn0raW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable write access watch in region\\[1\\]"]
    #[inline(always)]
    pub fn rgn1wa(&mut self) -> Rgn1waW<RegionensetSpec> {
        Rgn1waW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable read access watch in region\\[1\\]"]
    #[inline(always)]
    pub fn rgn1ra(&mut self) -> Rgn1raW<RegionensetSpec> {
        Rgn1raW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable write access watch in region\\[2\\]"]
    #[inline(always)]
    pub fn rgn2wa(&mut self) -> Rgn2waW<RegionensetSpec> {
        Rgn2waW::new(self, 4)
    }
    #[doc = "Bit 5 - Enable read access watch in region\\[2\\]"]
    #[inline(always)]
    pub fn rgn2ra(&mut self) -> Rgn2raW<RegionensetSpec> {
        Rgn2raW::new(self, 5)
    }
    #[doc = "Bit 6 - Enable write access watch in region\\[3\\]"]
    #[inline(always)]
    pub fn rgn3wa(&mut self) -> Rgn3waW<RegionensetSpec> {
        Rgn3waW::new(self, 6)
    }
    #[doc = "Bit 7 - Enable read access watch in region\\[3\\]"]
    #[inline(always)]
    pub fn rgn3ra(&mut self) -> Rgn3raW<RegionensetSpec> {
        Rgn3raW::new(self, 7)
    }
    #[doc = "Bit 24 - Enable write access watch in PREGION\\[0\\]"]
    #[inline(always)]
    pub fn prgn0wa(&mut self) -> Prgn0waW<RegionensetSpec> {
        Prgn0waW::new(self, 24)
    }
    #[doc = "Bit 25 - Enable read access watch in PREGION\\[0\\]"]
    #[inline(always)]
    pub fn prgn0ra(&mut self) -> Prgn0raW<RegionensetSpec> {
        Prgn0raW::new(self, 25)
    }
    #[doc = "Bit 26 - Enable write access watch in PREGION\\[1\\]"]
    #[inline(always)]
    pub fn prgn1wa(&mut self) -> Prgn1waW<RegionensetSpec> {
        Prgn1waW::new(self, 26)
    }
    #[doc = "Bit 27 - Enable read access watch in PREGION\\[1\\]"]
    #[inline(always)]
    pub fn prgn1ra(&mut self) -> Prgn1raW<RegionensetSpec> {
