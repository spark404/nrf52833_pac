...
pub type W = crate::W<B1Spec>;
#[doc = "Field `B1` reader - y-intercept of second piecewise linear function"]
pub type B1R = crate::FieldReader<u16>;
#[doc = "Field `B1` writer - y-intercept of second piecewise linear function"]
pub type B1W<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - y-intercept of second piecewise linear function"]
    #[inline(always)]
    pub fn b1(&self) -> B1R {
        B1R::new((self.bits & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:13 - y-intercept of second piecewise linear function"]
    #[inline(always)]
    pub fn b1(&mut self) -> B1W<B1Spec> {
        B1W::new(self, 0)
    }
}
#[doc = "y-intercept of second piecewise linear function\n\nYou can [`read`](crate::Reg::read) this register and get [`b1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`b1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct B1Spec;
...
impl crate::Writable for B1Spec {
