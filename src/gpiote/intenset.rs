...
impl W {
    #[doc = "Bit 0 - Write '1' to enable interrupt for event IN\\[0\\]"]
    #[inline(always)]
    pub fn in0(&mut self) -> In0W<IntensetSpec> {
        In0W::new(self, 0)
    }
    #[doc = "Bit 1 - Write '1' to enable interrupt for event IN\\[1\\]"]
    #[inline(always)]
    pub fn in1(&mut self) -> In1W<IntensetSpec> {
        In1W::new(self, 1)
    }
    #[doc = "Bit 2 - Write '1' to enable interrupt for event IN\\[2\\]"]
    #[inline(always)]
    pub fn in2(&mut self) -> In2W<IntensetSpec> {
        In2W::new(self, 2)
    }
    #[doc = "Bit 3 - Write '1' to enable interrupt for event IN\\[3\\]"]
    #[inline(always)]
    pub fn in3(&mut self) -> In3W<IntensetSpec> {
        In3W::new(self, 3)
    }
    #[doc = "Bit 4 - Write '1' to enable interrupt for event IN\\[4\\]"]
    #[inline(always)]
    pub fn in4(&mut self) -> In4W<IntensetSpec> {
        In4W::new(self, 4)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event IN\\[5\\]"]
    #[inline(always)]
    pub fn in5(&mut self) -> In5W<IntensetSpec> {
        In5W::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to enable interrupt for event IN\\[6\\]"]
    #[inline(always)]
    pub fn in6(&mut self) -> In6W<IntensetSpec> {
        In6W::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to enable interrupt for event IN\\[7\\]"]
    #[inline(always)]
    pub fn in7(&mut self) -> In7W<IntensetSpec> {
        In7W::new(self, 7)
    }
    #[doc = "Bit 31 - Write '1' to enable interrupt for event PORT"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<IntensetSpec> {
        PortW::new(self, 31)
    }
}
