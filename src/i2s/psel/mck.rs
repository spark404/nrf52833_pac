...
pub type R = crate::R<MckSpec>;
#[doc = "Register `MCK` writer"]
pub type W = crate::W<MckSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<MckSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<MckSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<MckSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for MCK signal.\n\nYou can [`read`](crate::Reg::read) this register and get [`mck::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mck::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MckSpec;
impl crate::RegisterSpec for MckSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mck::R`](R) reader structure"]
impl crate::Readable for MckSpec {}
#[doc = "`write(|w| ..)` method takes [`mck::W`](W) writer structure"]
impl crate::Writable for MckSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MCK to value 0xffff_ffff"]
impl crate::Resettable for MckSpec {
