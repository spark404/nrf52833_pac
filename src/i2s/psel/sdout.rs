...
pub type R = crate::R<SdoutSpec>;
#[doc = "Register `SDOUT` writer"]
pub type W = crate::W<SdoutSpec>;
...
#[doc = "Pin select for SDOUT signal.\n\nYou can [`read`](crate::Reg::read) this register and get [`sdout::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdout::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdoutSpec;
impl crate::RegisterSpec for SdoutSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdout::R`](R) reader structure"]
impl crate::Readable for SdoutSpec {}
#[doc = "`write(|w| ..)` method takes [`sdout::W`](W) writer structure"]
impl crate::Writable for SdoutSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SDOUT to value 0xffff_ffff"]
impl crate::Resettable for SdoutSpec {
