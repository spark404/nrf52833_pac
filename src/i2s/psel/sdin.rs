...
pub type R = crate::R<SdinSpec>;
#[doc = "Register `SDIN` writer"]
pub type W = crate::W<SdinSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<SdinSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<SdinSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<SdinSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for SDIN signal.\n\nYou can [`read`](crate::Reg::read) this register and get [`sdin::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdin::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdinSpec;
impl crate::RegisterSpec for SdinSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdin::R`](R) reader structure"]
impl crate::Readable for SdinSpec {}
#[doc = "`write(|w| ..)` method takes [`sdin::W`](W) writer structure"]
impl crate::Writable for SdinSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SDIN to value 0xffff_ffff"]
impl crate::Resettable for SdinSpec {
