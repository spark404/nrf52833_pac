...
#[doc = "Field `MAXCNT` reader - Maximum number of buffer words to transfer"]
pub type MaxcntR = crate::FieldReader<u16>;
#[doc = "Field `MAXCNT` writer - Maximum number of buffer words to transfer"]
pub type MaxcntW<'a, REG> = crate::FieldWriter<'a, REG, 14, u16>;
impl R {
    #[doc = "Bits 0:13 - Maximum number of buffer words to transfer"]
    #[inline(always)]
...
#[doc = "`reset()` method sets MAXCNT to value 0x1000"]
