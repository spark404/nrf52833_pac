...
impl W {
    ...
    #[doc = "Bit 24 - Include or exclude channel 24"]
    #[inline(always)]
    pub fn ch24(&mut self) -> Ch24W<ChgSpec> {
        Ch24W::new(self, 24)
    }
    #[doc = "Bit 25 - Include or exclude channel 25"]
    #[inline(always)]
    pub fn ch25(&mut self) -> Ch25W<ChgSpec> {
        Ch25W::new(self, 25)
    }
    #[doc = "Bit 26 - Include or exclude channel 26"]
    #[inline(always)]
    pub fn ch26(&mut self) -> Ch26W<ChgSpec> {
        Ch26W::new(self, 26)
    }
    #[doc = "Bit 27 - Include or exclude channel 27"]
    #[inline(always)]
    pub fn ch27(&mut self) -> Ch27W<ChgSpec> {
        Ch27W::new(self, 27)
    }
    #[doc = "Bit 28 - Include or exclude channel 28"]
    #[inline(always)]
    pub fn ch28(&mut self) -> Ch28W<ChgSpec> {
        Ch28W::new(self, 28)
    }
    #[doc = "Bit 29 - Include or exclude channel 29"]
    #[inline(always)]
    pub fn ch29(&mut self) -> Ch29W<ChgSpec> {
        Ch29W::new(self, 29)
    }
    #[doc = "Bit 30 - Include or exclude channel 30"]
    #[inline(always)]
    pub fn ch30(&mut self) -> Ch30W<ChgSpec> {
        Ch30W::new(self, 30)
    }
    #[doc = "Bit 31 - Include or exclude channel 31"]
    #[inline(always)]
    pub fn ch31(&mut self) -> Ch31W<ChgSpec> {
        Ch31W::new(self, 31)
    }
}
