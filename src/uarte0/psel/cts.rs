...
pub type R = crate::R<CtsSpec>;
#[doc = "Register `CTS` writer"]
pub type W = crate::W<CtsSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<CtsSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<CtsSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<CtsSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for CTS signal\n\nYou can [`read`](crate::Reg::read) this register and get [`cts::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cts::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CtsSpec;
impl crate::RegisterSpec for CtsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cts::R`](R) reader structure"]
impl crate::Readable for CtsSpec {}
#[doc = "`write(|w| ..)` method takes [`cts::W`](W) writer structure"]
impl crate::Writable for CtsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTS to value 0xffff_ffff"]
impl crate::Resettable for CtsSpec {
