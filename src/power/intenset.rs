...
impl W {
    #[doc = "Bit 2 - Write '1' to enable interrupt for event POFWARN"]
    #[inline(always)]
    pub fn pofwarn(&mut self) -> PofwarnW<IntensetSpec> {
        PofwarnW::new(self, 2)
    }
    #[doc = "Bit 5 - Write '1' to enable interrupt for event SLEEPENTER"]
    #[inline(always)]
    pub fn sleepenter(&mut self) -> SleepenterW<IntensetSpec> {
        SleepenterW::new(self, 5)
    }
    #[doc = "Bit 6 - Write '1' to enable interrupt for event SLEEPEXIT"]
    #[inline(always)]
    pub fn sleepexit(&mut self) -> SleepexitW<IntensetSpec> {
        SleepexitW::new(self, 6)
    }
    #[doc = "Bit 7 - Write '1' to enable interrupt for event USBDETECTED"]
    #[inline(always)]
    pub fn usbdetected(&mut self) -> UsbdetectedW<IntensetSpec> {
        UsbdetectedW::new(self, 7)
    }
    #[doc = "Bit 8 - Write '1' to enable interrupt for event USBREMOVED"]
    #[inline(always)]
    pub fn usbremoved(&mut self) -> UsbremovedW<IntensetSpec> {
        UsbremovedW::new(self, 8)
    }
    #[doc = "Bit 9 - Write '1' to enable interrupt for event USBPWRRDY"]
    #[inline(always)]
    pub fn usbpwrrdy(&mut self) -> UsbpwrrdyW<IntensetSpec> {
