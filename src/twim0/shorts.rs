...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum LastrxSuspend {
    #[doc = "0: Disable shortcut"]
    Disabled = 0,
    #[doc = "1: Enable shortcut"]
    Enabled = 1,
}
impl From<LastrxSuspend> for bool {
    #[inline(always)]
    fn from(variant: LastrxSuspend) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `LASTRX_SUSPEND` reader - Shortcut between event LASTRX and task SUSPEND"]
pub type LastrxSuspendR = crate::BitReader<LastrxSuspend>;
impl LastrxSuspendR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> LastrxSuspend {
        match self.bits {
            false => LastrxSuspend::Disabled,
            true => LastrxSuspend::Enabled,
        }
    }
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == LastrxSuspend::Disabled
    }
    #[doc = "Enable shortcut"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == LastrxSuspend::Enabled
    }
}
#[doc = "Field `LASTRX_SUSPEND` writer - Shortcut between event LASTRX and task SUSPEND"]
pub type LastrxSuspendW<'a, REG> = crate::BitWriter<'a, REG, LastrxSuspend>;
impl<'a, REG> LastrxSuspendW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable shortcut"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(LastrxSuspend::Disabled)
    }
    #[doc = "Enable shortcut"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(LastrxSuspend::Enabled)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn lastrx_suspend(&self) -> LastrxSuspendR {
        LastrxSuspendR::new(((self.bits >> 11) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 11 - Shortcut between event LASTRX and task SUSPEND"]
    #[inline(always)]
    pub fn lastrx_suspend(&mut self) -> LastrxSuspendW<ShortsSpec> {
        LastrxSuspendW::new(self, 11)
    }
    #[doc = "Bit 12 - Shortcut between event LASTRX and task STOP"]
    #[inline(always)]
