...
pub type R = crate::R<SdaSpec>;
#[doc = "Register `SDA` writer"]
pub type W = crate::W<SdaSpec>;
...
impl W {
    #[doc = "Bits 0:4 - Pin number"]
    #[inline(always)]
    pub fn pin(&mut self) -> PinW<SdaSpec> {
        PinW::new(self, 0)
    }
    #[doc = "Bit 5 - Port number"]
    #[inline(always)]
    pub fn port(&mut self) -> PortW<SdaSpec> {
        PortW::new(self, 5)
    }
    #[doc = "Bit 31 - Connection"]
    #[inline(always)]
    pub fn connect(&mut self) -> ConnectW<SdaSpec> {
        ConnectW::new(self, 31)
    }
}
#[doc = "Pin select for SDA signal\n\nYou can [`read`](crate::Reg::read) this register and get [`sda::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sda::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdaSpec;
impl crate::RegisterSpec for SdaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sda::R`](R) reader structure"]
impl crate::Readable for SdaSpec {}
#[doc = "`write(|w| ..)` method takes [`sda::W`](W) writer structure"]
impl crate::Writable for SdaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SDA to value 0xffff_ffff"]
impl crate::Resettable for SdaSpec {
